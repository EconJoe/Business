...
cd B:\Business\Data
use panel, clear
drop if election_year>2012
tab election_partic election_type

gen vote_A=(election_partic!="")
gen vote_G=(election_partic!="" & election_type=="G")
gen vote_P=(election_partic!="" & election_type=="P")
gen vote_L=(election_partic!="" & election_type=="L")
gen vote_S=(election_partic!="" & election_type=="S")

gen vote_P_D=(election_type=="P" & election_partic=="D")
gen vote_P_R=(election_type=="P" & election_partic=="R")
gen vote_P_O=(election_type=="P" & election_partic!="" & election_partic!="D" & election_partic!="R")

* Identify presidential and midterm election years
gen presyear=(election_year==2000 | election_year==2004 | election_year==2008 | election_year==2012 | election_year==2016)
gen midtyear=(election_year==2002 | election_year==2006 | election_year==2010 | election_year==2014)

gen vote_A_presyr=(election_partic!="" & presyear==1)
gen vote_G_presyr=(election_partic!="" & election_type=="G" & presyear==1)
gen vote_P_presyr=(election_partic!="" & election_type=="P" & presyear==1)
gen vote_L_presyr=(election_partic!="" & election_type=="L" & presyear==1)
gen vote_S_presyr=(election_partic!="" & election_type=="S" & presyear==1)

gen vote_P_D_presyr=(election_type=="P" & election_partic=="D" & presyear==1)
gen vote_P_R_presyr=(election_type=="P" & election_partic=="R" & presyear==1)
gen vote_P_O_presyr=(election_type=="P" & election_partic!="" & election_partic!="D" & election_partic!="R" & presyear==1)

collapse (sum) vote_*, by(stateid registered dateofbirth) fast

cd B:\Business\Data
save voterhistory_training, replace
